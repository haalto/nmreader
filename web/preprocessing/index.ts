//https://gist.github.com/codingnninja/346773f3db379796e5407a825497dc19
export function preprocessImage(canvas: HTMLCanvasElement) {
  ...
  blurARGB(image.data, canvas, 0.2);
...
function getARGB(data: any, i: any) {
  const offset = i * 4;
  return (
...
// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
function buildBlurKernel(r: any) {
  let radius = (r * 3.5) | 0;
...
// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
function blurARGB(pixels: any, canvas: any, radius: any) {
